...
Fig_3D_Source<-list(as.data.frame(plot_EFS_Vinc$data), as.data.frame(plot_EFS_Vind$data))
names(Fig_3D_Source)<-c("Vincristine","Vindesine")

write_xlsx(Fig_3D_Source, path=paste0(filepath,"docs/Source data/","Fig3D",".xlsx"))
